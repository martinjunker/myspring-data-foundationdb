...
public class MappingFoundationDbEntityInformation<T, ID> extends PersistentEntityInformation<T, ID>
     ...
     */
    public MappingFoundationDbEntityInformation(FoundationDbPersistentEntity<T> entity, @Nullable String customCollectionName, @Nullable Class<ID> fallbackIdType) {
        super(entity);
